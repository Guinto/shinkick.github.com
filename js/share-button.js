/*
	Based on: https://github.com/carrot/share-button
	Modifications for HearNow:
		* tumblr support
		* pinterest-specific new window size
		* adding titles to links for tooltips
*/
...
var ShareButton = (function (_ShareUtils) {
  ...
  _createClass(ShareButton, [{
    ...
    value: function _setup(element, opts) {
      ...
      if (this.config.ui.networkOrder.length === 0) this.config.ui.networkOrder = ['facebook', 'twitter', 'tumblr', 'googlePlus', 'pinterest', 'whatsapp', 'reddit', 'linkedin', 'email'];
      ...
      var _loop = function (k) {
        ...
        if (typeof network !== "undefined") {
          (function () {
            ...
            // HB MOD FROM: if (network.className !== 'email') a.setAttribute('onclick', 'return false');
	...
	/**
     * @method _networkTumblr
     * @description Create & display a Tumblr window
     * @private
     */
  }, {
    key: '_networkTumblr',
    value: function _networkTumblr(element) {
      this._updateHref(element, 'http://tumblr.com/widgets/share/tool', {
        canonicalUrl: this.config.networks.tumblr.url,
    ...
    value: function _injectHtml(instance) {
      ...
      try {
        for (var _iterator4 = networks[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
          ...
          networkList += '<li class=\'' + network + '\' data-network=\'' + network + '\'><a title=\''+network+'\'></a></li>';
        }
      } catch (err) {
...
var ShareUtils = (function () {
  ...
  _createClass(ShareUtils, [{
    ...
    value: function _show(el) {
      el.style.display = "inline-block"; // HB MOD FROM: "initial";
    }
    ...
    value: function _updateHref(element, url, params) {
      ...
      if (!encode && (!this.config.networks.facebook.loadSdk || element.getAttribute('class') !== 'facebook')) {
        ...
        if (element.getAttribute('class') == 'pinterest enabled') {
        	popup.width = 770;
        	popup.height = 650;
        }
